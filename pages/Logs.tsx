        ...
        <div className="lg:col-span-1 space-y-6">
             ...
             <div className="p-4 grid grid-cols-7 gap-1 text-center">
                ...
                {days.map(day => (
                  <button 
                    ...
                    className={`h-9 w-full flex items-center justify-center text-xs font-semibold rounded-md transition-all ${
                      selectedDate === day 
          ...
          <div className="gh-card p-5 bg-gradient-to-br from-white to-slate-50 shadow-sm">
             ...
             <div className="space-y-4">
               {[
                 { label: 'Identifications', val: '342', color: 'text-slate-800' },
                 { label: 'Security Alerts', val: '2', color: 'text-red-600 font-black' },
